...
Purchases run inside a Prisma database transaction with Serializable isolation and retry handling for P2034 serialization conflicts. This prevents two concurrent purchase requests for the same user from both passing the balance check and overspending below zero.
